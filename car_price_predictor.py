...
def main():
   ...
   """
    ...
    p1=st.number_input('What is the current ex-showroom price of the car ?(in lakhs)',2.5,50.0,step=1.0)
    
    p2=st.number_input('What is the distance covered by the car(in kilometres)?',100.0,500000000,step=100)
